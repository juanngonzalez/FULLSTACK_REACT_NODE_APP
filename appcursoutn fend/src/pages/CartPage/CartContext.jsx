...
export const CartContextProvider = ({children}) => {
    ...
    const deleteItem = (id_product) => {
        const itemFiltrado = cartList.filter((producto) => producto.id_product !== id_product)
        setCartList(itemFiltrado);
    }

    function agregarAlCarrito(items) {
        const indice = cartList.findIndex(i => i.id_product === items.id_product)
    ...
    const eliminarUno = (id) => {
        const indice = cartList.findIndex(i => i.id_product === id)
